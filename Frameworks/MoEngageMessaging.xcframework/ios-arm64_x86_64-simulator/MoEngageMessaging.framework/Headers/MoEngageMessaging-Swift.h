...
SWIFT_CLASS("_TtC17MoEngageMessaging27MoEngagePushCallBackHandler") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface MoEngagePushCallBackHandler : NSObject <UNUserNotificationCenterDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
