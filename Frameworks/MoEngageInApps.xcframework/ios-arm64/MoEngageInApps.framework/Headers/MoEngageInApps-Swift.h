...
/// :nodoc:
///
- (void)syncInAppsInAppFetchType:(MoEngageInAppSyncType)inAppFetchType previousIdentities:(NSDictionary<NSString *, NSString *> * _Nonnull)previousIdentities withCompletionBlock:(void (^ _Nonnull)(BOOL))completionBlock;
- (void)getSelfHandledInAppPostSync;
- (void)getSelfHandledInAppsPostSync;
- (NSDictionary<NSString *, id> * _Nonnull)fetchRequestBodyResultForTemplateFetch SWIFT_WARN_UNUSED_RESULT;
...
@class MoEngageAccessibilityData;
...
/// Dictionary to store parsed accessibility data
@property (nonatomic, copy) NSDictionary<NSString *, MoEngageAccessibilityData *> * _Nonnull parsedAccessibilityData;
...
/// Make the container view modal for accessibility to prevent focus from moving
/// outside the InApp view until it’s closed. Only applies to general in-apps,
/// non-intrusive in-apps allow focus to move outside.
...
@property (nonatomic, copy) NSString * _Nullable screenName SWIFT_DEPRECATED_MSG("Use screenNames instead.");
...
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull screenNames;
- (nonnull instancetype)initWithScreenNames:(NSArray<NSString *> * _Nonnull)screenNames contexts:(NSArray<NSString *> * _Nonnull)contexts OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// A custom content view that forwards specific properties to the parent container.
/// This is used inside a UIScrollView to properly handle dataSource and other properties.
SWIFT_CLASS("_TtC14MoEngageInApps30MoEngageInAppScrollContentView")
@interface MoEngageInAppScrollContentView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
/// Initialize with frame and parent container reference
/// \param frame The frame for the view
///
/// \param parentContainer The parent container that will contain this view
///
- (nonnull instancetype)initWithFrame:(CGRect)frame parentContainer:(MoEngageInAppPrimaryContainerView * _Nullable)parentContainer OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)addWidget:(UIView * _Nonnull)widget;
- (void)updateContentSize;
- (void)widgetSizeChanged:(UIView * _Nonnull)widget;
- (void)layoutSubviews;
@end
