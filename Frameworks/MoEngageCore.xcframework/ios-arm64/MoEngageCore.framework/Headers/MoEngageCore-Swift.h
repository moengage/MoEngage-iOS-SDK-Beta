...
SWIFT_CLASS("_TtC12MoEngageCore35MoEngageAnalyticsBatchSyncOperation")
...
SWIFT_CLASS("_TtC12MoEngageCore21MoEngageAnalyticsData")
...
SWIFT_CLASS("_TtC12MoEngageCore29MoEngageGroupSyncSynchronizer")
...
/// Protocol interfacing as condition evaluator class.
SWIFT_PROTOCOL("_TtP12MoEngageCore35MoEngageKMMConditionEvaluatorBridge_")
@protocol MoEngageKMMConditionEvaluatorBridge <NSObject>
- (BOOL)evaluateCampaignFilterCondition:(NSDictionary<NSString *, id> * _Nonnull)campaignFilterCondition trackedEventAttributes:(NSDictionary<NSString *, id> * _Nonnull)trackedEventAttributes SWIFT_WARN_UNUSED_RESULT;
@end


/// Protocol interfacing as log level class.
SWIFT_PROTOCOL("_TtP12MoEngageCore19MoEngageKMMLogLevel_")
@protocol MoEngageKMMLogLevel <NSObject>
+ (id _Nonnull)error SWIFT_WARN_UNUSED_RESULT;
+ (id _Nonnull)warn SWIFT_WARN_UNUSED_RESULT;
+ (id _Nonnull)info SWIFT_WARN_UNUSED_RESULT;
+ (id _Nonnull)debug SWIFT_WARN_UNUSED_RESULT;
+ (id _Nonnull)verbose SWIFT_WARN_UNUSED_RESULT;
@end

@class MoEngageLogger;

/// Protocol interfacing as logger handler class.
SWIFT_PROTOCOL("_TtP12MoEngageCore23MoEngageKMMLoggerBridge_")
@protocol MoEngageKMMLoggerBridge <NSObject>
+ (id _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)setLoggerKey:(NSString * _Nonnull)key logger:(MoEngageLogger * _Nonnull)logger;
@end


/// Protocol interfacing as kotlin utility class.
SWIFT_PROTOCOL("_TtP12MoEngageCore16MoEngageKMMUtils_")
@protocol MoEngageKMMUtils <NSObject>
+ (NSString * _Nonnull)getConditionEvaluatorVersion SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface MoEngageLogger (SWIFT_EXTENSION(MoEngageCore))
- (void)logLogLevel:(NSObject * _Nonnull)logLevel throwable:(id _Nullable)throwable message:(SWIFT_NOESCAPE NSString * _Nonnull (^ _Nonnull)(void))message;
@end
...
SWIFT_CLASS("_TtC12MoEngageCore15MoEngageSession")
...
SWIFT_CLASS("_TtC12MoEngageCore19MoEngageSessionInfo")
...
SWIFT_CLASS("_TtC12MoEngageCore14MoEngageSource")
...
SWIFT_CLASS("_TtC12MoEngageCore21MoEngageUserAttribute")
...
SWIFT_CLASS("_TtC12MoEngageCore27MoEngageUserAttributeEntity")
...
SWIFT_CLASS("_TtC12MoEngageCore26MoEngageUserAttributesData")
